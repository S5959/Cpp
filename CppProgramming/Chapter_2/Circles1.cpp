...
int main()
{
    ...
    CircleType c2 = {{30, 10}, 5};   // 중심(30,10), 반경 5으로 초기화

    cout << "원1" << endl;
    dispCircle(c1);                                       // 중심 : (0, 0) 반경 : 10
    cout <<  " 원1의 면적 : " << circleArea(c1) << endl;    // 원1의 면적 : 314.159

    cout << "원2" << endl;
    dispCircle(c2);                                       // 중심 : (30, 10) 반경 : 5
    cout <<  " 원2의 면적 : " << circleArea(c2) << endl;    // 원2의 면적 : 78.5398
